...
<template>
  <Tabs default-value="Stats" class="w-full flex flex-col items-center">
    ...
    <TabsContent value="Stats">
      <div class="grid grid-cols-4 gap-2 w-full">
        <div class="w-full">
          <Card class="h-[220px] flex flex-col justify-center items-center">
            <CardHeader>
              <CardTitle>
                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24">
                  <path
                    ...
                    stroke-width="2"
                    d="M16 17a1 1 0 1 0 2 0a1 1 0 1 0-2 0M6 7a1 1 0 1 0 2 0a1 1 0 1 0-2 0m0 11L18 6"
                  />
                </svg>
              </CardTitle>
              ...
              <CardTitle>
                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24">
                  <path
                    ...
                    stroke-linejoin="round"
                    stroke-width="2"
                    d="M14 12v.01M10 12v.01M12 10v.01M12 14v.01M4.5 12.5l8-8a4.94 4.94 0 0 1 7 7l-8 8a4.94 4.94 0 0 1-7-7"
                  />
                </svg>
              </CardTitle>
              <CardDescription></CardDescription>
    ...
    <TabsContent value="Charts" class="w-full">
